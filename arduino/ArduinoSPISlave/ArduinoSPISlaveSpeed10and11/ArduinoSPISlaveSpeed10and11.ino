...
//* Author: ackerman              *
//* Arduino IDE 1.8.11            *
//* Mode 10: 50 ms 640 baud (*,)  * 
//* Mode 11: 25 ms 1280 baud (#,)  *
//*********************************
...
//volatile uint8_t data_buff[DATA_LEN]={0x73,0x5A,0x00,0x00,0x00,0x00,0x00,0x00,0xFF};
...
void Speed10ms16Flag(void);
void Speed10ms17Flag(void);
void Speed10ms18Flag(void);
void Speed10ms20Flag(void);
...
void EnviaDatos()
{
 ...
 {//Con flag
  ...
  {
   default: break;     
   case 16: Speed10ms16Flag(); break;
   case 17: Speed10ms17Flag(); break;
   case 18: Speed10ms18Flag(); break;
   case 20: Speed10ms20Flag(); break;     
...
{
 gb_cont_buf= 0;
 gb_flipflop= 0x01; //Mando analogico   
 data_buff[begin_buttons0] = 0x00; //Ponemos a 0  
 data_buff[begin_buttons1] = 0x0F; //Fin mando analogico   
 gb_cont_nibble=0;
...
void loop() {
 ...
 switch (gb_aux)
 {
  ...
  case 36: gbDelay = 25; gb_aux=0; break; //$ Velocidad
